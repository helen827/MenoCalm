...
public class AppProperties {
    ...
    public static class Security {
        ...
        /**
         * Comma-separated JWT subject user ids allowed to access {@code /api/v1/admin/community/**}.
         */
        private String communityAdminUserIds = "";
        ...
        public String getCommunityAdminUserIds() {
            return communityAdminUserIds;
        }

        public void setCommunityAdminUserIds(String communityAdminUserIds) {
            this.communityAdminUserIds = communityAdminUserIds;
        }
    }
    ...
    public static class Ai {
        ...
        /** Markdown chat (Component A); slightly higher default for more natural wording. */
        @DecimalMin("0.0")
        @DecimalMax("2.0")
        private double chatTemperature = 0.55;
        /** Silent symptom JSON extraction (Component B). */
        @DecimalMin("0.0")
        @DecimalMax("2.0")
        private double extractionTemperature = 0.3;
        /** Weekly narrative report (Component C). */
        @DecimalMin("0.0")
        @DecimalMax("2.0")
        private double reportTemperature = 0.7;
        ...
        public double getReportTemperature() {
            return reportTemperature;
        }

        public void setReportTemperature(double reportTemperature) {
