...
public class CommunityMediaService {
    ...
    public MediaPresignResponse createPresign(String userId, MediaPresignRequest request) {
        ...
        response.setPublicUrl(buildPublicUrl(storage, visibility, objectKey));
    ...
    private String buildPublicUrl(AppProperties.Storage storage, String visibility, String objectKey) {
